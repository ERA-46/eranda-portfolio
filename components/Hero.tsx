    ...
    <section id="hero" className="min-h-screen flex items-center pt-16">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex gap-4 flex-wrap">
          <a
            href="#projects"
            className="px-6 py-3 bg-gray-700 text-white rounded-lg shadow-md hover:shadow-lg hover:scale-103 transition-all duration-500"
          >
            View Projects
          </a>
          <a
            ...
            className="px-6 py-3 bg-gray-700 text-white rounded-lg hover:bg-black hover:text-blue-500 transition-all duration-500"
          >
            Download Resume
          </a>
        </div>
